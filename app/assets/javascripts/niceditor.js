...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		if (!e)
			return e;
		//if (c)
		//	var panelElm = new bkElement('DIV').setStyle(c).appendBefore(e);
		//else
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			var s = {width: newX+'px', border : '1px solid #ccc', borderTop : 0, overflowY : 'auto', overflowX: 'hidden', backgroundColor: 'white' };
	...
	findElm : function(tag,attr,val) {
		var list = this.getElm().getElementsByTagName(tag);
	...
	mouseClick : function(){
		if(!this.isDisabled) {
			if(this.pane && this.pane.pane) {
				...
				this.im = this.ne.selectedInstance.selElm().parentTag('IMG');
				this.ne.selectedInstance.saveRng();
				ce6.editor.savedSel = this.ne.selectedInstance.savedSel;
				ce6.editor.selectedInstance = this.ne.selectedInstance;
				ce6.editor.openImageDlg();
			}
		}
	},
//	addPane : function() {
